                ...
                <div className="flex items-center justify-center p-1.5 sm:p-4 lg:p-6">
                  <div className="relative w-full md:pl-4 sm:pl-10 pl-5  md:pr-4 sm:pr-10 pr-5">
                    <div className="w-full relative" style={{ height: "45vh" }}>
                      ...
                      {/* after clinking on the video setting this appear howevern it not that much usefull */}
                      {/* {settingDialogueOpen ? (
                        <SettingDialogueBox
                      ...
                      {/* two btn for mic and video before joining */}
                    ...
                    {/* shows the check audio and video before only for desktop */}
                    {/* {!isMobile &&
